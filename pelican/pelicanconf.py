...
# $ pip install ghp-import pelican pelican-liquid-tags pelican-avatar
# $ pip install webassets cssmin typogrify libgravatar
# $ pelican-quickstart
...
PLUGINS +=['pelican.plugins.liquid_tags',
            'pelican.plugins.liquid_tags.literal',
           'pelican.plugins.liquid_tags.include_code',
           'pelican.plugins.liquid_tags.notebook',
           'pelican.plugins.liquid_tags.graphviz',
           'pelican.plugins.liquid_tags.diag',
           'pelican.plugins.liquid_tags.img',
           'pelican.plugins.liquid_tags.b64img',
           'pelican.plugins.liquid_tags.audio',
           'pelican.plugins.liquid_tags.video',
           'pelican.plugins.liquid_tags.gram',
           'pelican.plugins.liquid_tags.youtube',
           'pelican.plugins.liquid_tags.flickr',
           'pelican.plugins.liquid_tags.giphy',
           'pelican.plugins.liquid_tags.vimeo',
           'pelican.plugins.liquid_tags.spotify',
           'pelican.plugins.liquid_tags.soundcloud',
           ]
THEME = 'themes/elegant'
PATH = 'content'
AVATAR_AUTHOR_EMAIL='abaelhe@icloud.com'
